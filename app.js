(function () {
  ...
  // Absent on pages that carry no subscribe form of their own — 404.html reuses
  // this same script (for its language switcher and i18n) but has nothing to
  // subscribe to.
